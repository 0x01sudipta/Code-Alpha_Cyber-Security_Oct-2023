...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Clone hub!</h1>
                    <p>We have the top branded high quality first copy shoes including Nike, Adidas and Sparx for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
           ...
           <footer class="footer">
               ...
               <center>
                   ...
                   <p>Developed by <a href="https://0x01sudipta.github.io/portfolio" target="_blank">Sudipta Biswas</a></p>
               </center>
               </div>
           </footer>
        </div>
